...
\subsection{Zweck}
Die Software „Quick Deal“ bietet Kunden und Anbietern eine Plattform für Spontaneinkäufe.
...
Das System muss, je nach Auswahl des Administrator, den zu verwaltenden Benutzer in der Datenbank ändern.
...
\begin{itemize}
	\item Mit der finalen Software müssen mindestens 300 Personen gleichzeitig arbeiten können. 
...
\begin{itemize}
	\item Pro Tag müssen mit der finalen Version der Software und geeignetem Server mindestens 25.000 Anzeigen erstellt werden können. 
	\item Pro Tag müssen mit der finalen Version der Software und geeignetem Server mindestens 2.500.000 Anzeigen angesehen werden können.
\end{itemize}
Im Rahmen dieses Praktikums muss der Prototyp für die finale Software entwickelt werden.
...
Der System-Administratoristrator hat Zugriff auf alle Daten dieser Datenbank, da er die Datenbank verwaltet. 
